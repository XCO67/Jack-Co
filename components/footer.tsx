...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-[oklch(0.25_0.08_250)]" aria-label="Site footer">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <nav className="space-y-2 text-sm text-gray-400 font-inter" aria-label="Footer navigation">
              {navigation.map((item) => (
                <div key={item.href}>
                  <Link href={item.href} className="hover:text-[oklch(0.65_0.25_250)] transition-colors">
                    {item.label}
                  </Link>
                </div>
              ))}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm text-gray-400 font-inter">
              <div>
                <Link href="/services" className="hover:text-[oklch(0.65_0.25_250)] transition-colors">
                  Event Planning
                </Link>
              </div>
              <div>
            ...
            <div className="space-y-2 text-sm text-gray-400 font-inter">
              <div>
                <Link 
                  ...
                  className="hover:text-[oklch(0.65_0.25_250)] transition-colors flex items-center space-x-2"
                  target="_blank"
            ...
            <div className="space-y-2 text-sm text-gray-400 font-inter">
              <div>
                <a 
                  ...
                  className="hover:text-[oklch(0.65_0.25_250)] transition-colors"
                >
